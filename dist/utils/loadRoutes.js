...
function configureRouter(app) {
    ...
    app.route(_apiAttributes.OrganizationRoute.GetAllForUpdate).get((0, _middlewares.checkAccessKey)(), organizationController.getAllForUpdate.bind(organizationController));
