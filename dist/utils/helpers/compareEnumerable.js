...
Object.defineProperty(exports, "compareEnumerable", {
    enumerable: true,
    get: function() {
        return compareEnumerable;
    }
});
function compareEnumerable(db_array, request_array, compare_field) {
    if (!Array.isArray(db_array) || !Array.isArray(request_array)) return false;
    ...
    const db_map = {}; // Type of map based on compare_field type
